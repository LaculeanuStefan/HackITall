    ...
    <form method="post" action="formEmotions.php">
        <div class="optionBox"> 
            <div class="options">
                ...
                <fieldset id="group1">
                    <input type="radio" name="option1" value="5"> Fericit.<br>
                    <input type="radio" name="option1" value="4"> Entuziasmat.<br>
                    <input type="radio" name="option1" value="3"> Speriat.<br>
                    <input type="radio" name="option1" value="2"> Suparat.<br>
                    <input type="radio" name="option1" value="1"> Furios.
                </fieldset>
            </div>
        </div> 
        ...
        <div class="optionBox">
            <div class="options">
                ...
                <fieldset id="group2">
                    <input type="radio" name="option2" value="5"> Foarte mult.<br>
                    <input type="radio" name="option2" value="4"> Mult.<br>
                    <input type="radio" name="option2" value="3"> Putin.<br>
                    <input type="radio" name="option2" value="2"> Aproape deloc.<br>
                    <input type="radio" name="option2" value="1"> Deloc.
                </fieldset>
            </div>
        </div>
        ...
        <div class="optionBox">
            <div class="options">
                <h4 style="color: #8B0000">
                    Ai avut dificultati in a te concentra in ceea ce a trebuit sa faci?
                </h4>
        ...
        <div class="optionBox">
            <div class="options">
                <h4 style="color: #8B0000">
                    Cat de obosit te simti?
                </h4>

                <fieldset id="group4">
                    <input type="radio" name="option4" value="1"> Foarte obosit.<br>
                    <input type="radio" name="option4" value="2"> Obosit.<br>
