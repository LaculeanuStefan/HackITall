...
<body>
    ...
    <form method="post" action="formEmotions.php">
        <div class="optionBox"> 
            <div class="options">
                <h4 style="color: #8B0000">
                      Cum te-ai simtit pana la masa de pranz?
                </h4>

                <fieldset id="group1">
                    <input type="radio" name="option1" value="1"> Indispus.<br>
                    <input type="radio" name="option1" value="2"> Destul de grea.<br>
        ...
        <div class="optionBox">
            <div class="options">
                <h4 style="color: #8B0000">
                    Cum a fost ziua ta pana acum?
                </h4>

                <fieldset id="group2">
                    <input type="radio" name="option2" value="1"> Obositoare.<br>
                    <input type="radio" name="option2" value="2"> Destul de obositoare.<br>
                    <input type="radio" name="option2" value="3"> Asa si asa.<br>
                    <input type="radio" name="option2" value="4"> Relaxata.<br>
                    <input type="radio" name="option2" value="5"> Foarte relaxata.
                </fieldset>
            </div>
        </div>
        ...
        <div class="optionBox">
            <div class="options">
                <h4 style="color: #8B0000">
                    Aveti pofta de mancare?
                </h4>

                <fieldset id="group4">
                    <input type="radio" name="option4" value="1"> Deloc.<br>
                    <input type="radio" name="option4" value="2"> Aproape deloc.<br>
                    <input type="radio" name="option4" value="3"> Asa si asa.<br>
                    <input type="radio" name="option4" value="4"> Destul de multa.<br>
                    <input type="radio" name="option4" value="5"> Foarte multa.
                </fieldset>
            </div>
        </div>
